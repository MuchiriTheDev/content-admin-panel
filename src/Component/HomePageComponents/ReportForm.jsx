// src/components/common/ReportForm.jsx
import React, { useState } from 'react';
import { motion, AnimatePresence } from 'framer-motion';
import { FiX, FiDownload } from 'react-icons/fi';
import { toast } from 'react-hot-toast';
import { generateUserReport } from '../../Resources/Apiservice';
...
const ReportForm = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      link.href = url;
      link.setAttribute('download', 'CCI_User_Report.docx');
        ...
        >
          ...
          >
            <div className="flex justify-between items-center mb-4">
              <h4 className="text-xl font-bold text-brown">Generate User Report</h4>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="block text-sm text-gray-600">Insurance Status</label>
                <select
                  name="status"
